...
: G4VUserPrimaryGeneratorAction(),fParticleGun(0), fMessenger(0), fDetector(det)
{
  G4int n_particle = 1;
  ...
  fMessenger->DeclareMethod("UpdateGunPosition", &PrimaryGeneratorAction::UpdatePrimaryGunPosition, "...doc...");
}
...
void PrimaryGeneratorAction::UpdatePrimaryGunPosition() {
  G4double x = 0.*cm;
  G4double y = 0.*cm;
