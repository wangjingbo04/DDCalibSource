...
//  G4Element* Na = man->FindOrBuildElement("Na");
  ...
  G4Material* MgF2 = new G4Material("MgF2", 3.15*g/cm3, ncomponents=2, //MgF2
                         kStateSolid);
  ...
  G4Material* TiF3 = new G4Material("TiF3", 3.4*g/cm3, ncomponents=2, kStateSolid); //TiF3
  ...
  G4Material* LiF = new G4Material("LiF", 2.64*g/cm3, ncomponents=2, //LiF
                         kStateSolid);
  LiF->AddElement(Li, natoms=1);
  LiF->AddElement(F, natoms=1);
  
  G4Material* Fluental = new G4Material ("Fluental", density, ncomponents=3);
  Fluental->AddElement (Al, fractionmass = 0.30*perCent);
  Fluental->AddMaterial (AlF3, fractionmass = 0.69*perCent);
  Fluental->AddMaterial (LiF, fractionmass = 0.01*perCent);
