...
: G4VUserPrimaryGeneratorAction(),fParticleGun(0), fDetector(det)
{
  ...
  G4double x = 0.*cm;
  G4double y = 0.*cm;
  G4double z = det->GetInsulatorHeight()/2 - det->GetInsulatorThickness() + det->GetThermalAbsorborHeight() + det->GetFilter3Height() + det->GetFilter2Height() 
               + det->GetFilter1Height() + det->GetModeratorHeight() + 2.0*cm;
...
void PrimaryGeneratorAction::UpdateGunPosition() {
  G4double x = 0.*cm;
  G4double y = 0.*cm;
  G4double z = fDetector->GetInsulatorHeight()/2 - fDetector->GetInsulatorThickness() + fDetector->GetThermalAbsorborHeight() + fDetector->GetFilter3Height() + fDetector->GetFilter2Height() 
               + fDetector->GetFilter1Height() + fDetector->GetModeratorHeight() + 2.0*cm ;
  fParticleGun->SetParticlePosition(G4ThreeVector(x, y, z));	
}
